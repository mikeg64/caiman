        ...
        try
            ...
            try
                ...
                switch newImageName{kk,1}(end-1:end)
                    case 'ME'
                        RGBName             = strcat(newImageName{kk,1}(1:end-9),'RGB_names');
                        RGBImagesListName   = strcat('http://carlos-reyes.staff.shef.ac.uk/caiman/imageUploads/',RGBName);
                        [RGBImagesList,errs]= urlread(RGBImagesListName);
                        ...
                        if ~isempty(isBlue)
                            ...
                            dataOut(:,:,3)  = dataB;
                            [q1,q2]=urlread(strcat('http://carlos-reyes.staff.shef.ac.uk/caiman/clearOldFiles.php?idFileTC=',nameFileBlue(15:end)));
                            [q1,q2]=urlread(strcat('http://carlos-reyes.staff.shef.ac.uk/caiman/clearOldFiles.php?idFileTC=',strcat(nameFileBlue(15:end-9),'RGB_names')));
                            [q1,q2]=urlread(strcat('http://carlos-reyes.staff.shef.ac.uk/caiman/clearOldFiles.php?idFileTC=',strcat(nameFileBlue(15:end-9),'userEmail')));
			    else
                        ...
                        if ~isempty(isGreen)
                            ...
                            dataOut(:,:,2)  = dataG;
                            [q1,q2]=urlread(strcat('http://carlos-reyes.staff.shef.ac.uk/caiman/clearOldFiles.php?idFileTC=',nameFileGreen(15:end)));
                            [q1,q2]=urlread(strcat('http://carlos-reyes.staff.shef.ac.uk/caiman/clearOldFiles.php?idFileTC=',strcat(nameFileGreen(15:end-9),'RGB_names')));
                            [q1,q2]=urlread(strcat('http://carlos-reyes.staff.shef.ac.uk/caiman/clearOldFiles.php?idFileTC=',strcat(nameFileGreen(15:end-9),'userEmail')));
                        end
                        ...
                        if ~isempty(isRed)
                            ...
                            dataOut(:,:,1)  = dataR;
                            [q1,q2]=urlread(strcat('http://carlos-reyes.staff.shef.ac.uk/caiman/clearOldFiles.php?idFileTC=',nameFileRed(15:end)));
                            [q1,q2]=urlread(strcat('http://carlos-reyes.staff.shef.ac.uk/caiman/clearOldFiles.php?idFileTC=',strcat(nameFileRed(15:end-9),'RGB_names')));
                            [q1,q2]=urlread(strcat('http://carlos-reyes.staff.shef.ac.uk/caiman/clearOldFiles.php?idFileTC=',strcat(nameFileRed(15:end-9),'userEmail')));
                        end
