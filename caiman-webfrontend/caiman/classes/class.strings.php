...
class Strings
{
    ...
    function validateFileName3($fileName)
    {
        return (eregi("[ ,+|\/?<>,!@�$%^&*=-*(*)*']", $fileName))? true : false;
    }
    ...
    function validateFileName($fileName)
    {
         	...
         	for ($i=0; $i<strlen($fileName); $i++)
         	{
				...
				$charAsciiVal = ord  ( $fileName[$i]  );
         		...
         		if (($charAsciiVal<46)||($charAsciiVal==47)||($charAsciiVal==96))
         		{
         		 	$numChars++;         		 	
         		}
         		if (($charAsciiVal<65)&&($charAsciiVal>57))
         		{
         		 	$numChars++;         		 	
         		}
          		if (($charAsciiVal<95)&&($charAsciiVal>91))
         		{
         		 	$numChars++;         		 	
         		}
         		if ($charAsciiVal>123) 
